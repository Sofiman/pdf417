...
const W: usize = pdf417_width!(COLS, 1, 0, true) as usize;
const H: usize = pdf417_height!(ROWS, 1, 0) as usize;
...
fn main() {
    ...
    let pdf417 = PDF417::new(&input, ROWS as u32, COLS as u32, LEVEL)
        .truncated(true);
