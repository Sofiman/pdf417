...
impl<'a> PDF417Encoder<'a> {
    ...
    /// ECC codewords. Be careful, when generating a micro PDF417 the `val`
    ...
    /// codewords are generated by this function. Be careful, when generating
    /// a micro PDF417 the `val` parameter represents the variant, otherwise the
    /// `val` parameter represents the ECC level.
...
mod tests {
    ...
    fn test_encode_ascii_simple() {
        ...
        PDF417Encoder::new(&mut codewords, false).append_ascii("Test");
    ...
    fn test_generate_ascii_switch_modes() {
        ...
        PDF417Encoder::new(&mut codewords, false).append_ascii("abc1D234\x1B");
    ...
    fn test_generate_ascii_numeric() {
        ...
        PDF417Encoder::new(&mut codewords, false).append_ascii("12345678987654321 num");
    ...
    fn test_encode_num() {
        ...
        PDF417Encoder::new(&mut codewords, false).append_num(12345678987654321);
    ...
    fn test_encode_bytes_multiple() {
        ...
        PDF417Encoder::new(&mut codewords, false).append_bytes(b"alcool");
    ...
    fn test_encode_bytes_not_multiple() {
        ...
        PDF417Encoder::new(&mut codewords, false).append_bytes(b"encode bin");
